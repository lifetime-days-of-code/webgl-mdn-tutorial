...
function main() {
  ...
  // Initializing the 2 shaders
  // pass to WebGL, compile and link togheter
  ...
  function initShadersProgram(gl, vsSource, fsSource) {
    ...
    if (!gl.getProgramParameter(shaderProgram, gl.LINK_STATUS)) {
      alert(
        'Inable to initialize the shader prgoram: ' +
  ...
  function initBuffers(gl) {
    // Crete a buffer for the square's position
    ...
    // Now create an array of position for the squre
...
//TODO: DEBUG why the square is not rendering
//TODO: NEXT chapter: https://developer.mozilla.org/en-US/docs/Web/API/WebGL_API/Tutorial/Using_shaders_to_apply_color_in_WebGL
window.onload = main();
